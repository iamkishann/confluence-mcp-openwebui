...
### Open WebUI + Confluence MCP

Run Open WebUI and a Confluence-focused MCP Atlassian service in the same Compose stack:
...
Then register `http://mcp-atlassian:8000/mcp` in Open WebUI as an MCP server.
